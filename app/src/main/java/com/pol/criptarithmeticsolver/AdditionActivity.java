...
public class AdditionActivity extends AppCompatActivity {
    ...
    Button btn;
    Spinner s11,s12,s13,s14,s21,s22,s23,s24,s31,s32,s33,s34,s35;
    String number[];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s35 = findViewById(R.id.spinner35);
        ...
        s35.setAdapter(adapter);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdditionActivity.this,AddResultActivity.class);
